# [V2-01] Full-run failures / warnings
...
完整 V2 run `v2-full-20260607-041127` 执行到 V2-01 簇时发现以下 Fail / Warning。测试未因这些问题暂停，后续簇已继续执行。

截图：

- `sections/agenthub_ui/.ai/issue/screenshots/v2-full-20260607-041127/V2-01-04/01_result.png`
...
| Case | Status | Finding |
|---|---|---|
| V2-01-04 多端登录被踢 | FAIL | Attempted im_web/kickout counterpart at http://172.18.58.156:3000; HTTP status=200. No im_web UI/kickout overlay observed. |
