...
function __VLS_template() {
    ...
    [UserProfileDrawer,];
    {
        ...
        {
            const __VLS_79 = {}.ChatSidePreview;
            const __VLS_80 = __VLS_asFunctionalComponent(__VLS_79, new __VLS_79({ ...{ 'onClose': {}, }, visible: ((__VLS_ctx.sidePreview.visible)), type: ((__VLS_ctx.sidePreview.type)), title: ((__VLS_ctx.sidePreview.title)), subtitle: ((__VLS_ctx.sidePreview.subtitle)), sourceUrl: ((__VLS_ctx.sidePreview.sourceUrl)), sourceText: ((__VLS_ctx.sidePreview.sourceText)), extension: ((__VLS_ctx.sidePreview.extension)), loading: ((__VLS_ctx.sidePreview.loading)), error: ((__VLS_ctx.sidePreview.error)), }));
            ({}.ChatSidePreview);
            const __VLS_81 = __VLS_80({ ...{ 'onClose': {}, }, visible: ((__VLS_ctx.sidePreview.visible)), type: ((__VLS_ctx.sidePreview.type)), title: ((__VLS_ctx.sidePreview.title)), subtitle: ((__VLS_ctx.sidePreview.subtitle)), sourceUrl: ((__VLS_ctx.sidePreview.sourceUrl)), sourceText: ((__VLS_ctx.sidePreview.sourceText)), extension: ((__VLS_ctx.sidePreview.extension)), loading: ((__VLS_ctx.sidePreview.loading)), error: ((__VLS_ctx.sidePreview.error)), }, ...__VLS_functionalComponentArgsRest(__VLS_80));
            ...
            __VLS_84 = { close: (__VLS_ctx.closeSidePreview) };
            const __VLS_82 = __VLS_pickFunctionalComponentCtx(__VLS_79, __VLS_81);
            let __VLS_83;
        }
        {
            const __VLS_85 = {}.ClowderConversationPanel;
            const __VLS_86 = __VLS_asFunctionalComponent(__VLS_85, new __VLS_85({ ...{ 'onClose': {}, }, visible: ((__VLS_ctx.showClowderPanel)), channelId: ((__VLS_ctx.channelId)), channelType: ((__VLS_ctx.channelType)), }));
            ({}.ClowderConversationPanel);
            const __VLS_87 = __VLS_86({ ...{ 'onClose': {}, }, visible: ((__VLS_ctx.showClowderPanel)), channelId: ((__VLS_ctx.channelId)), channelType: ((__VLS_ctx.channelType)), }, ...__VLS_functionalComponentArgsRest(__VLS_86));
            ({}({ ...{ 'onClose': {}, }, visible: ((__VLS_ctx.showClowderPanel)), channelId: ((__VLS_ctx.channelId)), channelType: ((__VLS_ctx.channelType)), }));
            let __VLS_90 = { 'close': __VLS_pickEvent(__VLS_89['close'], {}.onClose) };
            __VLS_90 = { close: $event => {
                    __VLS_ctx.showClowderPanel = false;
                    // @ts-ignore
                    [channelId, channelType, channelId, channelType, channelId, channelType, handleOpenPreview, channelId, channelType, channelId, channelType, channelId, channelType, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, sidePreview, closeSidePreview, showClowderPanel, channelId, channelType, showClowderPanel, channelId, channelType, showClowderPanel, channelId, channelType, showClowderPanel,];
                }
            };
        ...
        if (__VLS_ctx.channelType === 2) {
            {
                const __VLS_91 = {}.GroupSettingsDrawer;
                const __VLS_92 = __VLS_asFunctionalComponent(__VLS_91, new __VLS_91({ ...{ 'onClose': {}, 'onMembersClick': {}, }, groupNo: ((__VLS_ctx.channelId)), visible: ((__VLS_ctx.showGroupSettings)), }));
                ({}.GroupSettingsDrawer);
                const __VLS_93 = __VLS_92({ ...{ 'onClose': {}, 'onMembersClick': {}, }, groupNo: ((__VLS_ctx.channelId)), visible: ((__VLS_ctx.showGroupSettings)), }, ...__VLS_functionalComponentArgsRest(__VLS_92));
                ({}({ ...{ 'onClose': {}, 'onMembersClick': {}, }, groupNo: ((__VLS_ctx.channelId)), visible: ((__VLS_ctx.showGroupSettings)), }));
                let __VLS_96 = { 'close': __VLS_pickEvent(__VLS_95['close'], {}.onClose) };
                __VLS_96 = { close: $event => {
                        if (!((__VLS_ctx.channelType === 2)))
                            return;
                ...
                let __VLS_97 = { 'members-click': __VLS_pickEvent(__VLS_95['members-click'], {}.onMembersClick) };
                __VLS_97 = { "members-click": (__VLS_ctx.handleMembersClick) };
        ...
        if (__VLS_ctx.channelType === 1) {
            {
                const __VLS_98 = {}.UserProfileDrawer;
                const __VLS_99 = __VLS_asFunctionalComponent(__VLS_98, new __VLS_98({ ...{ 'onClose': {}, }, uid: ((__VLS_ctx.channelId)), visible: ((__VLS_ctx.showUserProfile)), }));
                ({}.UserProfileDrawer);
                const __VLS_100 = __VLS_99({ ...{ 'onClose': {}, }, uid: ((__VLS_ctx.channelId)), visible: ((__VLS_ctx.showUserProfile)), }, ...__VLS_functionalComponentArgsRest(__VLS_99));
                ({}({ ...{ 'onClose': {}, }, uid: ((__VLS_ctx.channelId)), visible: ((__VLS_ctx.showUserProfile)), }));
                let __VLS_103 = { 'close': __VLS_pickEvent(__VLS_102['close'], {}.onClose) };
                __VLS_103 = { close: $event => {
                        if (!((__VLS_ctx.channelType === 1)))
                            return;
