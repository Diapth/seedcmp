...
- [X] T104 Run full IM Web `pnpm test:unit` and record final output in `sections/im_web/.ai/V3.0/evidence.md`
- [X] T105 Run runnable IM Web `pnpm test:e2e` smoke suite and record final output in `sections/im_web/.ai/V3.0/evidence.md`
