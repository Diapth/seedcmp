...
- Browser evidence:
  ...
  - Ran live cat-only group create/send smoke on `http://100.79.157.76:3000` as `18337488675`:
    ...
    - Screenshots:
      - `sections/im_web/.ai/V3.0/assets/screenshots/v3-18-cat-only-create-send-20260530121334-01-picker.png`
      - `sections/im_web/.ai/V3.0/assets/screenshots/v3-18-cat-only-create-send-20260530121334-02-created.png`
      - `sections/im_web/.ai/V3.0/assets/screenshots/v3-18-cat-only-create-send-20260530121334-03-after-send.png`
  ...
  - Ran follow-up live cat group regression smoke for the 2026-05-30 bug list:
    ...
    - Screenshots:
      - `sections/im_web/.ai/V3.0/assets/screenshots/v3-18-cat-group-regression-20260530125243-01-mention.png`
      - `sections/im_web/.ai/V3.0/assets/screenshots/v3-18-cat-group-regression-20260530125243-02-after-send.png`
      - `sections/im_web/.ai/V3.0/assets/screenshots/v3-18-cat-group-regression-20260530125243-03-after-wait.png`
      - `sections/im_web/.ai/V3.0/assets/screenshots/v3-18-cat-group-regression-20260530125243-04-members.png`
  ...
  - Opened the live new-cat console after the platform fix:
    ...
    - Result JSON: `sections/im_web/.ai/V3.0/assets/screenshots/v3-18-cat-console-platform-20260530T143250-result.json`.
