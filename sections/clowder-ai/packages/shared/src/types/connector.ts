...
const CONNECTOR_DEFINITIONS: readonly ConnectorDefinition[] = [
  ...
  },
  {
    ...
    displayName: 'IM Web',
    icon: 'message-circle',
    color: { primary: '#0F766E', secondary: '#ECFDF5' },
    description: 'TangSengDaoDao IM Web connector',
    tailwindTheme: {
      avatar: 'bg-conn-teal-bg ring-2 ring-conn-teal-ring',
      label: 'text-conn-teal-text',
      labelLink: 'text-conn-teal-text hover:text-conn-teal-hover',
      bubble: 'border border-conn-teal-bubble-border bg-conn-teal-bubble-bg',
    },
  },
  {
    id: 'telegram',
