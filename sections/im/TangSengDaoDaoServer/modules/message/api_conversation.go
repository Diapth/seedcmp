...
func (co *Conversation) clearConversationUnread(c *wkhttp.Context) {
	...
	if err != nil {
		co.Error("命令发送失败！", zap.String("cmd", common.CMDConversationUnreadClear), zap.String("uid", loginUID), zap.String("channelID", req.ChannelID), zap.Uint8("channelType", req.ChannelType))
	}
	c.ResponseOK()
}
